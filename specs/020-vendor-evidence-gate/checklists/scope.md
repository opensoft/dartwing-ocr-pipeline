...
- [x] CHK004 Is the opt-in mechanism pinned as `--evidence-gate-skip-fallback` + `LEDGERLINC_EVIDENCE_GATE_SKIP_FALLBACK`, with no value-bearing preset selection axis at landing? [Clarity, R-020.1 / R-020.2 / cli-contract.md]
