...
from dartwing_ocr.evaluator.exceptions import EmptyCorpusError
from dartwing_ocr.evaluator.filenames import (
    EVAL_DOC_FILENAME,
    EVAL_RUN_SUMMARY_FILENAME,
)
from dartwing_ocr.evaluator.gates import DocumentPassFail
from dartwing_ocr.evaluator.io import read_json, write_json, write_text
...
def evaluate_corpus(
    ...
    *,
    ...
    from dartwing_ocr.evaluator.report import render_run_summary
