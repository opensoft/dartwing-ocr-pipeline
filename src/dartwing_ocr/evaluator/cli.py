...
from dartwing_ocr.evaluator.exceptions import EvaluatorError
from dartwing_ocr.evaluator.scoring import CONTRACT_SET_VERSION, ResultLabel
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m dartwing_ocr.evaluator",
...
def _handle_corpus(args: argparse.Namespace) -> int:
    from dartwing_ocr.evaluator.corpus import evaluate_corpus
...
def _prepare_corpus_for_evaluation(
    ...
    from dartwing_ocr.evaluator.corpus import list_document_folders
    from dartwing_ocr.evaluator.pipeline_invocation import (
