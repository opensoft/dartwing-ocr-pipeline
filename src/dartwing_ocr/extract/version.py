...
`dartwing_ocr._build_sha` when that module is present (populated at package
...
def _package_version() -> str:
    try:
        return _dist_version("dartwing-ocr")
...
def _short_sha() -> str:
    try:
        module = importlib.import_module("dartwing_ocr._build_sha")
    except ImportError:
        return "unknown"
