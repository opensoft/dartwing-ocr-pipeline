...
_PACKAGED_CONFIGS = ("dartwing_ocr.extract.voters", "configs")
...
def _resolve(name_or_path: str, base_dir: Path | None) -> Path:
    ...
    # 2. Name: look in $DARTWING_VOTER_CONFIG_DIR first.
    override_dir = os.environ.get("DARTWING_VOTER_CONFIG_DIR")
    if override_dir:
    ...
    raise VoterConfigInvalid(
        ...
        detail={
            "searched": [
                override_dir or "$DARTWING_VOTER_CONFIG_DIR (unset)",
