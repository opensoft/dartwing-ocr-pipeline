...
class CLIInvocation:
    ...
    # `DARTWING_GPU_WARMUP=1` against the resolved preprocess profile
...
def _format_stage_exception(
    ...
    from dartwing_ocr.preprocessing.errors import WarmupError as _WarmupError
...
class Runner:
    ...
    def _resolve_callable_for_stage(
        ...
        *,
        ...
        from dartwing_ocr.pipeline.stages import resolve_stage_callable
...
def _classify_stage_exception(exc: Exception) -> ExitCode:
    ...
    """
    from dartwing_ocr.pipeline.stages import DeferredImplementationError
