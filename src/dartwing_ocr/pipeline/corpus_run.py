...
from dartwing_ocr.pipeline.path_resolution import derive_document_id
from dartwing_ocr.pipeline.pdf_check import is_pdf
from dartwing_ocr.pipeline.profiles import Stage
...
def run_warm_corpus(  # NOSONAR S3776 — legacy orchestrator; behavior-preserving split is deferred to a follow-up refactor.
    *,
    ...
    """
    from dartwing_ocr.pipeline.cli import _build_resolved_plan, _emit_failure, _emit_stdout_summary
    ...
    # `--gpu-warmup` plus env var `DARTWING_GPU_WARMUP=1` (CLI wins).
