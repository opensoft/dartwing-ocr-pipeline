...
standalone `python -m dartwing_ocr.preprocessing.preflight` CLI
...
def classify(
    *,
    ...
    from dartwing_ocr.preprocessing.presets import (  # noqa: F401
        DetRecVariant,
        ModuleSetPreset,
    )
...
# T015: make `python -m dartwing_ocr.preprocessing.preflight` runnable
