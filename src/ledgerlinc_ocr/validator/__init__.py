"""Public surface for the LedgerLinc stage 1 contract validator.
...
def validate_folder(
    ...
    *,
    ...
    from ledgerlinc_ocr.validator.folder import validate_folder as _impl
...
def validate_corpus(
    ...
    *,
    ...
    from ledgerlinc_ocr.validator.corpus import validate_corpus as _impl
