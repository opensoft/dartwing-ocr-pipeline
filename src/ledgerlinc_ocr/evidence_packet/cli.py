"""``ledgerlinc-evidence-packet`` CLI.

Thin wrapper over :func:`ledgerlinc_ocr.evidence_packet.assemble_from_folder`.
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="ledgerlinc-evidence-packet",
        description=(
    ...
    parser.add_argument(
        ...
        default=0,
        help=(
            "Raise the ledgerlinc_ocr logger to DEBUG and persist "
...
def _configure_logging(verbose: int) -> None:
    ...
    already_installed = any(
        ...
        and getattr(h, "_ledgerlinc_cli", False)
    ...
    if not already_installed:
        ...
        handler._ledgerlinc_cli = True  # type: ignore[attr-defined]
